...
# --- clean_text tests (pure logic, no model needed) ---
...
@patch('app.get_resources')  
def test_predict_negative_sentiment(mock_res, client):
    mock_model = MagicMock()
